...
#ggsave(filename = file.path(out.dir, "UMAP_seurat_annotations.pdf"), plot     = p1, device   = cairo_pdf,  width    = 12, height   = 8)
```
...
#ggsave(filename = file.path(out.dir, "UMAP_seurat_annotations.pdf"), plot = last_plot(), device = cairo_pdf, width = 12, height = 8)
```
...
ggsave(
  filename = file.path(out.dir, "Li_data_Dotplot_sysact.pdf"),
  plot     = p,
  width    = 8,   # keep wide enough for labels
  height   = 6,   # increase height for more y-space
  dpi      = 300
)
